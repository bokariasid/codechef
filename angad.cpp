...
struct partition B, C;      // blocks (consist of states)
...
int main(){
  ...
  //cout<<"hello world!!\n";
  cout<<"\nEnter no. of states:"; cin >> nn;
  cout <<"\nNo. of transitions:";cin >> mm;
  cout<<"\nInitial state:";cin >> q0;
  cout<<"\nNo. of final states:";cin >> ff;
  ...
  /* Read transitions */
  for( int t = 0; t < mm; ++t ){
    cout<<"\nEnter tail of transition "<<t+1<<" :";
    cin >> T[t];
    cout<<"\nEnter label of transition "<<t+1<<" :";cin >> L[t]; 
    cout<<"\nEnter head of transition "<<t+1<<" :";cin>> H[t]; }
  ...
  for( int i = 0; i < ff; ++i ){
    int q; cout<<"Which state you want to go to ?:";cin >> q;
